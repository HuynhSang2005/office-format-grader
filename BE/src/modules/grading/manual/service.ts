import type { GradingResult, GradingDetail, PowerPointGradingResult } from "../types.ts";
import type { ParsedPowerPointFormatData } from "../../powerpoint/types.ts";
import { getRubric, getLatestRubric, onRubricUpdated } from "../rubric/powerpointRubric.ts";
import { updateTotalScore } from "../rubric/helpers.ts";
