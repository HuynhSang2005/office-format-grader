 ...
 */
export function checkTransitions(data: ParsedPowerPointFormatData): GradingDetail {
    ...
    const hasSlide2WithSound = data.slides.length > 1 && 
                              !!data.slides[1]?.transition?.sound?.name;
